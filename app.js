...
Vue.component("sect", {
    props: ["data"],
    template: "\n  <div class=\"section\" :style=\"{backgroundColor: data.current?'rgba(' + data.color[0] + ',' + data.color[1] + ',' + data.color[2] + ',0.5)':''}\">\n    <h1 v-if=\"data.title\" class=\"title\"><div class=\"section-icon\" v-if=\"data.sectionIcon\" v-html=\"data.sectionIcon\"></div>{{data.title}}</h1>\n    <div class=\"content\" v-if=\"data.content\" v-html=\"data.content\" v-on:click=\"comp\"></div>\n  </div>\n  ",
    methods: {
        comp: function (el) {
            console.log(el);
            Vue.compile(el);
    ...
    data: {
        ...
        sections: [
            ...
            },
            {
                ...
                color: [175, 21, 61],
                current: false,
                content: "<iframe v-if=\"true\" frameborder=\"0\" scrolling=\"auto\" src=\"https://credly.com/earnedembed/2407921/12/45891/0/1\" width=\"100%\" height=\"100%\"></iframe>",
